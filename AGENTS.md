...
- The root `index.ts` is an example workflow script (that happens to implement a development workflow for this very repository)

## Rules

- Workflow scripts like `index.ts` should implement loops, decisions, agent and command invocations, and other control flow constructs to implement a workflow.
